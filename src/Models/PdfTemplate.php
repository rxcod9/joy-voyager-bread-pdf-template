...
namespace Joy\VoyagerBreadPdfTemplate\Models;
...
use Joy\VoyagerBreadPdfTemplate\Database\Factories\PdfTemplateFactory;
...
class PdfTemplate extends Model
{
    ...
    {
        return $this->belongsTo(Voyager::modelClass('PdfTemplate'));
    }
